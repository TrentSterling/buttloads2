...
Local 2.12.0 checkpoint: the town, friendly merchants, upper caves and cinder-moth combat are implemented. The heart now opens a continuation to 297 m with four lower strata, five additional seeded cave networks and three restorable stations. Their drilling/lift/scanner rewards and Otis return services work through the existing economy and persistence. Old upper terrain is copied exactly into the extended field. The fresh-claim journey reached 279.1 m, repaired all stations, saved/reloaded and used the town return route. See DEEP-WORKINGS.md and VERIFICATION.md. The boss, lower enemy roster, final transformation, parcels and further residents remain outstanding. This is progress toward the complete plan, not completion of the goal.
...
Checkpoint C now has its descent, structure rewards and return routes. Next: build the Foreman Below encounter in the existing 278 m chamber, with terrain-aware attacks, tool/explosive interactions, persistent phases and a reward that changes the mine or town. Add a complete encounter journey and old-save tests. The room currently contains no boss; do not treat reaching it or this local build as completing the goal. Preserve the existing station rewards, upper recoveries and saved terrain.
...
- Current automated baseline: 183 system checks and a complete fresh-start journey through all upper recoveries, three lower station repairs, a 279.1 m save/reload and Otis return travel. The preceding combat checkpoint also passed the combined thunderstone/freight/mysteries campaign and a fresh-start drill/axe encounter journey. Add focused tests for newly introduced failure modes and run the relevant regressions, rather than repeatedly running unchanged checks.
