...
export async function nodeGame() {
  ...
  for (const file of ['render', 'scenery', 'ruins', 'crane', 'feedback-view', 'thunderstone-view', 'town-view', 'cavern-view', 'combat-view', 'deep-view', 'foreman-view', 'rescue-view', 'crawler-view', 'kinetic-view', 'parcel-view', 'fossil-view']) vm.runInThisContext(fs.readFileSync(path.join(root, 'src', file + '.js'), 'utf8'));
