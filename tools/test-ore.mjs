...
if (!globalThis.B2?.OreSystem) for (const name of ['core', 'mesher', 'world', 'player', 'ore', 'expedition', 'gadgets', 'thunderstone', 'freight', 'mysteries', 'survey', 'persistence', 'feedback', 'audio', 'fieldkit']) vm.runInThisContext(fs.readFileSync(path.join(root, 'src', name + '.js'), 'utf8'));
