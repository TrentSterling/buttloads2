...
passed += (await import('./test-common.mjs')).commonChecks;
passed += (await import('./test-underground-art.mjs')).undergroundArtChecks;
passed += (await import('./test-foreman-art.mjs')).foremanArtChecks;
